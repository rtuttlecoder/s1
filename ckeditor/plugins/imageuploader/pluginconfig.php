...
$browserfolder = pathinfo("/images/productImages/index.html");
$browserfolder = ltrim($browserfolder["dirname"], '/');
$usersiteroot = "http://$_SERVER[HTTP_HOST]"; // substr($_SERVER["SCRIPT_FILENAME"], 0, (stripos($_SERVER["SCRIPT_FILENAME"], $_SERVER["SCRIPT_NAME"])+1));
