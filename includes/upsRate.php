...
class upsRate {
    ...
    function getRate($PostalCode,$dest_zip,$service,$length,$width,$height,$weight,$toState,$fromState) {
	...
	$data ="<?xml version=\"1.0\"?>  
		...
		curl_close($ch);  
		return $params['RATINGSERVICESELECTIONRESPONSE']['RATEDSHIPMENT']['NEGOTIATEDRATES']['NETSUMMARYCHARGES']['GRANDTOTAL']['MONETARYVALUE'];
	    }  
    }
?>