<?php
/**
 * Order Now options panel include
 *
 * Version: 1.3
...
try {
	...
	if($prodid == 'VIP') {
		...
		$result_des = mysql_query($sql_des) or die(mysql_error());
	...
	if(!isset($_SESSION["email"]) || $_SESSION["email"] == '') {
		...
		$result_chkvip = mysql_query($sql_chkvip) or die(mysql_error());
...
$(function() {
			...
			$("#continueImprint").click(function() {
				if(configured == -1) { 
					...
					<?php if($ProductType != "Bundle") { ?>
						window.location.href = "imprintproduct.php?id=$_GET['id']";
					<?php } else { ?>
			         	window.location.href = "imprintproductBundle.php?id=$_GET['id']";
					<?php } ?>
					});
				}
		});
		...
		$.post("includes/inc_details2.php", {
			...
			if(parseFloat(data)<parseFloat($("#qty").val())) {
				...
				// $.post("includes/inc_detailsnew.php", {
	...
	// when qty box is filled in load additional script file from includes dir
	$("#qty").blur(function() {
...
<div id="moreview">
<!-- #popupwindow -->
<div id="moreimages" class="window" style="text-align: center;"><a href="#" class="close" style="float: right;">Close</a>
<?php
...
<!-- ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: -->
    ...
    <div class="browser_color detailed_options" <?=$rightbarheight;?> >
      ...
      <?php
		...
		if($num_color > 0 && $row_color1["Color"] != '') {
              ...
              <?php
					...
					$sql_size = "SELECT DISTINCT Size, SizeSKU FROM product_options WHERE ProductID=$prodid  ORDER BY id";
      ...
      <?php
			if($prodid == 'VIP' || (isset($_GET['t']) && $_GET['t'] == 'free')) {
        ...
        <input type="text" <?=$edit;?> value="1" id="qty" name="qty" size="5">
        <div class="clear"></div>
	...
	<div class="clear"></div>
		...
		<div style="margin-bottom:20px">
         <?php  if($ID_IMPRINT_CATEGORY!=0 && $ID_IMPRINT_CATEGORY!=-1){ ?>
			<div style="background-color: rgb(254, 0, 0); height: 61px; width: 199px; margin-left: -16px;"">
			<input type="checkbox" name="imprint" onclick="imprintCheckValid(this)" /><label  style="color: rgb(255, 255, 255); margin-top: 23px;" >Add imprinting Option</label>
			</div>							 
			<button type="button" id="addCart" name="addCart" value="" onclick="window.location.hash = 'details';" style="margin-right:0px"   class="cart"></button>
		...
		<?php } elseif($ProductType == "Bundle") {?>	
        	<button type="button" id="addCart" name="addCart" value=""  onclick="window.location.hash = 'details';" style="margin-right:0px"  class="cart"></button>
        <?php } else {?>	
        	<button type="button" id="addCart" name="addCart" value=""  class="cart" style="margin-right:0px"></button>
        <?php } ?>
		 </div>
	...
	?>
                ...
                <!-- Add to Cart button -->
                <button type="button" id="addCart2" name="addCart" value="" class="cart"></button>
