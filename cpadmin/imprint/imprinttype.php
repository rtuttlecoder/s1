        ...
        <tbody>
          <tr>
            <td width="180" valign="top" align="left" class="setting"><table width="100%" border="0" cellpadding="5" cellspacing="1">
                ...
                <tr>
                  <td bgcolor="#000000"><a href="secondtabs.php?ipd=<?php echo $_GET['idp'];?>"><span class="style9">Second Tab</span></a></td>
                </tr>
                <tr>
                  <td bgcolor="#000000"><a href="editcategories.php?idp=<?php echo $_GET['idp'];?>"><span class="style9">Category</span></a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td bgcolor="#666666"><a href="imprinttype.php"><span class="style1">Imprint Type</span></a></td>
                </tr>
              </table></td>
      ...
      <tr>
        ...
        <input type="submit" name="button11" id="newImpType" value="Add More Types" /></td>
          ...
          <tr>
            ...
            <td width="43%" align="left" valign="middle" bgcolor="<?php echo $bgcolor;?>">
