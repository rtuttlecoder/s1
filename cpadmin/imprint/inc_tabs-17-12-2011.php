		  ...
		  echo "<table style='width:100%'> 
		  			<tr>
						...
						foreach($listColors as $keys => $valuec){
							...
							echo "<a href='#' id='ic".$idcolor."'><img src='../images/".$options_color->getimages()."' alt='".$options_color->getname()."' style='float: left; clear: none; border: medium none; padding: 0px; margin-right: 2px;width:20px;height:20px;'/></a>";
						}
