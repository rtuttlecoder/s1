			...
			<table border="0" cellpadding="0" cellspacing="0" style="margin: 0 0 0 2px;">
				<tr>
				  ...
				  <td class="img_change" style="height: 42px; width: 130px;">
						<form id="frmImg<?=$num;?>" action="" method="post" enctype="multipart/form-data" target="imgUpload" style="position: relative;"> <!-- includes/imgUpload.php -->
						<input style="position: absolute; -moz-opacity:0; filter:alpha(opacity: 0); opacity: 0; width: 100px; height: 15px;" type="file" id="file<?=$num;?>" name="file" onchange="$('#colorimg<?=$num;?>').val($('#file<?=$num;?>').val()); $('#frmImg<?=$num;?>').submit(); $('#img<?=$num;?>').attr('src', '../images/productImages/'+$('#file<?=$num;?>').val());" />
	...
	<table border="0" cellpadding="0" cellspacing="0" style="margin: 0 0 0 2px;">
 		<tr>
          ...
          <td class="img_change" style="height: 42px; width: 150px;">
                <form id="frmImg<?=$c_num;?>" action="" method="post" enctype="multipart/form-data" target="imgUpload" style="position: relative;">
          		<input style="position: absolute; -moz-opacity:0; filter:alpha(opacity: 0); opacity: 0; width: 100px;" type="file" id="file<?=$c_num;?>" name="file" onchange="$('#colorimg<?=$c_num;?>').val($('#file<?=$c_num;?>').val()); $('#frmImg<?=$c_num;?>').submit(); $('#img<?=$c_num;?>').attr('src', '../images/productImages/'+$('#file<?=$c_num;?>').val());" />
