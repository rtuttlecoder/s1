...
<tr>
  ...
  <td align="center" bgcolor="<?php echo $bgcolor; ?>"><a href="editimprint.php?idp=<?php echo $value->getIDCATEGORY();?>">Edit</a> | <a href="#" onClick="deleteImprintCateg(this)" id="<?php echo $value->getIDCATEGORY();?>">Delete</a>|
    <?php if($value->getenabled()==0) echo "Enable"; else echo "Disable";?></td>
</tr>
<?php
		$i++;
	}
	...
	foreach( $optionsList as $key => $value ){
		...
		$optionsHTML.='
 		 <tr>
		    ...
		    <td bgcolor="'.$bgcolor.'" align="center"><a href="#" id="option'.$value->getIDOPTION().'" onclick="showEditOption(this)">Edit</a> |<a href="#" onclick="confirmDeleteOption(this)" id="op'.$value->getIDOPTION().'"> Delete</a>| Disable</td>
		  </tr>';
	}
	$optionsHTML.='	</tbody>
					</table>';
...
<table width="100%">
    <tr>
     ...
     <tr>
       ...
       <td><input type="text" name="nbrImg"/></td>
	</tr>   
     <tr>
