...
if(isset($_POST["newMainTab"])){
	if(!isset($_SESSION["token"])){
		$mainTab = $_POST["newMainTab"];
		$id = $_GET['idp'];
		$imp_category_tabs = new imp_category_tabs();
		$imp_category_tabs->settab_name($mainTab);
		$imp_category_tabs->setis_parent("1");
		$imp_category_tabs->setimprint_categ_id($id);
...
if(isset($_GET["del"])){
	$imp_category_tabs = new imp_category_tabs();
	$dparams = array();
	$dparams["id_tab"] = $_GET['del'];
	$imp_category_tabs->delete($dparams);
}
...
<div class="Master_div">
  ...
  <div class="PD_main_form1">
    <div class="">
        ...
        <tbody>
          <tr>
            <td width="180" valign="top" align="left" class="setting"><table width="100%" border="0" cellpadding="5" cellspacing="1">
                <tr>
                  <td bgcolor="#666666"><a href=""><span class="style9">Main Tab</span></a></td>
                </tr>
                <tr>
            ...
            <td valign="top" align="left"><form action="" method="post">
              ...
              <h1 align="center">MAIN TAB SETTING</h1>
              <div>
                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                  <tr>
                    <td width="50%" align="left" bgcolor="#CCCCCC"><strong>Available Tabs</strong></td>
                    <td width="50%" align="right" bgcolor="#CCCCCC"><input type="submit" name="button10" id="button10" value="Save &amp; Updates" onclick="document.forms.newSubTabs.submit()" />
                      <input type="submit" name="button6" id="newbutton" value="Add New Tab" /></td>
                  </tr>
                </table>
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
      <tr>
        <td width="12%" bgcolor="#FF0000"><div align="center"><strong>ID</strong></div></td>
        <td width="55%" bgcolor="#FF0000"><div align="center"><strong>Tab Name</strong></div></td>
        <td width="33%" bgcolor="#FF0000"><div align="center"><strong>Action</strong></div></td>
      </tr>
      <?php 
	  // list Main Tabs
		...
		$params = array();
		$params["is_parent"]=1;
		$params["imprint_categ_id"] = $_GET['idp'];
		$maintabs = array();
		$maintabs = $imp_category_tabs->readArray($params);
		$i=1;
		$bgcolor ="#F2F2F2";
      ...
      <td bgcolor="<?php echo $bgcolor;?>"><div class="editable<?php echo $value->getid_tab();?>" id="t<?php echo $value->getid_tab();?>"><?php echo $value->gettab_name();?></div></td>
      <td align="center" bgcolor="<?php echo $bgcolor;?>"><a href="#" onclick="inlineedit(this)" id="<?php echo $value->getid_tab();?>" style="color:#333333">Edit</a>|<a  style="color:#333333" href="editimprint2.php?idp=<?php echo $_GET['idp'];?>&del=<?php echo $value->getid_tab();?>">Delete</a></td>      
      </tr>
      <?php 
	  		$i++;
			echo "<script> $('.editable".$value->getid_tab()."').editable('./imprint/savetabs.php');</script>";
	  	}
	  ?>
      </table>
       ...
       <form name="newSubTabs" id="newSubTabs" action="" method="post">
          <table width="100%" border="0" cellpadding="5" cellspacing="0">
          <tr>
          <td>&nbsp;</td><td>Sub Tab</td><td><input type="text" name="newMainTab" /><input type="hidden" name="idp" value="<?php echo $_GET['idp'];?>"/><input type="hidden" name="token" value="<?php echo rand();?>" /></td><td>&nbsp;</td>
          </tr>
          </table>
          </form>
          </div>
