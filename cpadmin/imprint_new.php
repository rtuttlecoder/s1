<?php
	...
	if(isset($_POST["btnImpAdd"])) {
			...
			if($name != "") {
				$sql_imadd = "INSERT INTO imprint_categories(Name, Description) VALUES ('$name', '$desc')";
	...
	if(isset($_POST["btnImpEdit"])) {
		...
		if($impName != "") {
			$sql_impupdate = "UPDATE imprint_categories SET Name='$impName', Description='$impDesc' WHERE id=$impCatID LIMIT 1";
